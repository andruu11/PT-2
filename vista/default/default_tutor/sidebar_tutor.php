...
<ul class="navbar-nav ml-auto ml-md-0">
    ...
    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
        <a class="dropdown-item" href="../../views/views_tutor/perfil_tutor.php">Mi Perfil</a>
        <a class="dropdown-item" href="../../views/views_tutor/usuarios_tutor.php">Usuarios</a>
...
<ul class="sidebar navbar-nav">
    <li class="nav-item">
    <a class="nav-link" href="../../views/views_tutor/index_tutor.php">
    ...
    <li class="nav-item">
    <a class="nav-link" href="../../views/views_tutor/reportes_tutor.php">
        <i class="fas fa-fw fa-chart-area"></i>
        <span>Datos de mi cuenta</span></a>
    </li>
