<form name="crud"  method="post" enctype="multipart/form-data" action="../../../modelo/model_admin/editar_documento.php" id="nuevo_so">
<div class="modal fade" id="Modal_Editar_Prueba" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
  ...
  <div class="form-group col-md-12">
            ...
            <input type="hidden" class="form-control" id="id_usuario" name="id_usuario" value="1" required> 
...
<div class="form-group col-md-12">
            ...
            <input type="file" class="form-control" id="fuente" name="fuente"> 
</div>
</div>
